...
Параметры `OIDC_*` обычно менять не нужно; они полезны только если ВШЭ изменит настройки клиента/redirect URI или вы тестируете альтернативную конфигурацию.
